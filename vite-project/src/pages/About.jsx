...
import Resume from '../assets/Luis_Magana_Software_Engineer_Resume.pdf';
...
const About = () => {
  return (
    <section className={'max-container bg-black'}>
      ...
      <h1 className='blue-gradient_text font-semibold drop-shadow'>
        Contact_Me:
        <ul class="text-green-300 font-normal list-inside list-disc pl-10 marker:text-white">
          <li>
      ...
      <h1 className='blue-gradient_text font-semibold drop-shadow'>
        ...
        <ul class="text-green-300 font-normal list-inside list-disc pl-10 marker:text-white">
          <li>
          <a href = {Resume} target = "_blank">Download_PDF</a>
          </li>
        </ul>
      </h1>
